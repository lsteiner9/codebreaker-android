...
public class GameFragment extends Fragment implements InputFilter {
  ...
  private void setupMaps() {
    ...
    this.codeCharacters = getString(R.string.color_codes).chars()
  ...
  private void setupViews() {
    ...
    binding.summary.setOnClickListener((view) ->
        Navigation.findNavController(getView()).navigate(R.id.action_navigation_game_to_navigation_summary));
